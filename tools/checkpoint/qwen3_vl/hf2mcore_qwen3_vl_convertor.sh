...
PATH_SIZE=16
MAX_POSITION_EMBEDDINGS=262144 # max_position_embeddings
...
NUM_ATTN_HEADS=32 # num_attention_heads
INTERMEDIATE_SIZE=9728 # intermediate_size
...
echo "Copying tokenizer files from ${PRETRAIN_CHECKPOINT_PATH} to ${TARGET_CKPT_PATH}"
...
cmd="torchrun ${DISTRIBUTED_ARGS} hf2mcore_qwen3_vl.py \
    --qk-layernorm \
    --kv-channels 128 \
