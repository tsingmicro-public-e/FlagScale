...
class DiT(ModelMixin, ConfigMixin):
    ...
    # register_to_config automatically registers constructor args into config, accessible via self.config.xxx instead of self.xxx
    @register_to_config  # Registers constructor args into config. TODO: replace with our singleton pattern, write a mergeable @merge_param_config
    def __init__(
        self,
        ...
        **kwargs,
        ...
        self.timestep_encoder = TimestepEncoder(  # TODO BUG: self.config.compute_dtype works during training but errors during eval
