# Copied from https://github.com/huggingface/lerobot/blob/2b304eeb841ae6c371e3dd341bbbb9dd254b07cb/src/lerobot/policies/pi05/processor_pi05.py
...
from flagscale.models.pi05.modeling_pi05 import pad_vector
...
def make_pi05_pre_post_processors(
    config: PI05Config, dataset_stats: dict[str, dict[str, torch.Tensor]] | None = None
) -> tuple[
