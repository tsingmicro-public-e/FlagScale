# Copied from https://github.com/huggingface/lerobot/blob/2b304eeb841ae6c371e3dd341bbbb9dd254b07cb/src/lerobot/common/processors/pipeline.py
...
class DataProcessorPipeline(HubMixin, Generic[TInput, TOutput]):
    ...
    @classmethod
    def _load_config(
        cls, model_id: str, config_filename: str, hub_download_kwargs: dict[str, Any]
        ...
        **Common state file examples**:
        ...
        if base_path and (base_path / state_filename).exists():
            ...
            state_path = hf_hub_download(
                repo_id=model_id, filename=state_filename, repo_type="model", **hub_download_kwargs
            )
