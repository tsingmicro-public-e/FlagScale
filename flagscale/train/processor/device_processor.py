# Copied from https://github.com/huggingface/lerobot/blob/2b304eeb841ae6c371e3dd341bbbb9dd254b07cb/src/lerobot/common/processors/device_processor.py
...
class DeviceProcessorStep(ProcessorStep):
    ...
    def __call__(self, transition: EnvTransition) -> EnvTransition:
        ...
        dict_tensor_keys = [TransitionKey.OBSERVATION, TransitionKey.COMPLEMENTARY_DATA]
