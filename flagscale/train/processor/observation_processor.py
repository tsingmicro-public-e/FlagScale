# Copied from https://github.com/huggingface/lerobot/blob/2b304eeb841ae6c371e3dd341bbbb9dd254b07cb/src/lerobot/common/processors/observation_processor.py
    ...
    **State Processing:**
    ...
    def transform_features(
        ...
        **Renaming Rules:**
        ...
        prefix_pairs = {"pixels.": f"{OBS_IMAGES}."}
