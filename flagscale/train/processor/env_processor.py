# Copied from https://github.com/huggingface/lerobot/blob/2b304eeb841ae6c371e3dd341bbbb9dd254b07cb/src/lerobot/common/processors/env_processor.py
...
from flagscale.models.utils.constants import OBS_IMAGES, OBS_STATE
    ...
    **Image Processing:**
    ...
    def transform_features(
        ...
        state_feats["observation.state"] = PolicyFeature(
            ...
            dtype="float32",
            description=(
                "Concatenated end-effector position (3), axis-angle (3), and gripper qpos (2)."
            ),
        )
