# Copied from https://github.com/huggingface/lerobot/blob/2b304eeb841ae6c371e3dd341bbbb9dd254b07cb/src/lerobot/datasets/v30/utils.py
...
from flagscale.train.datasets.backward_compatibility import (
    FUTURE_MESSAGE,
