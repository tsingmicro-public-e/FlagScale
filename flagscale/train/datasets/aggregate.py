# Copied from https://github.com/huggingface/lerobot/blob/2b304eeb841ae6c371e3dd341bbbb9dd254b07cb/src/lerobot/datasets/v30/aggregate.py
...
from flagscale.train.datasets.video_utils import concatenate_video_files, get_video_duration_in_s
...
def update_meta_data(df, dst_meta, meta_idx, data_idx, videos_idx):
...
def aggregate_metadata(src_meta, dst_meta, meta_idx, data_idx, videos_idx):
    ...
    for chunk_idx, file_idx in chunk_file_ids:
        ...
        df = pd.read_parquet(src_path)
        df = update_meta_data(df, dst_meta, meta_idx, data_idx, videos_idx)
