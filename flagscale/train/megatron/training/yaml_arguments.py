...
def validate_yaml(args, defaults={}):
    ...
    assert args.world_size % args.model_parallel.tensor_model_parallel_size == 0, (
    ...
    if args.model_parallel.tp_comm_overlap:
        assert args.model_parallel.sequence_parallel == True, (
...
def core_transformer_config_from_yaml(args, transfomer_key="language_model"):
    ...
    assert args.activation_func in ["swiglu", "squaredrelu", "gelu"], (
